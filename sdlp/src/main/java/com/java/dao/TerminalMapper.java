...
public interface TerminalMapper {
     ...
     public List<TerminalResult> queryTerminal(@Param("mtype")String mtype, @Param("isuse")String isuse,  @Param("owner")String owner, @Param("devicenum")String devicenum, @Param("usedate")Date usedate, @Param("terminalid") Integer terminalid, @Param("customernum") String customernum);
